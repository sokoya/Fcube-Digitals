...
import { ValidateIkeja, clearLoginErrorMessage, PayIkeja} from "../../Redux/Actions/Electricity.action";
...
class IkejaScreen extends Component {
...
/////////////////////////////////////////////
        ...
        await this.props.ValidateIkeja(this.state.dataplanId, this.state.userPhone)
    };
    Hide= ()=>{
    ...
    MakePayment= async()=>{ 
      ...
      await this.props.PayIkeja(this.state.dataplanId, this.state.userPhone,this.state.Amount,id)}
    render(){
...
export default connect( MapStateToProps, {ValidateIkeja,clearLoginErrorMessage ,PayIkeja})(IkejaScreen);
