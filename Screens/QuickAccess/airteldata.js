...
import { GetAirtelndata, BuyData, ClearErrorMgs } from "../../Redux/Actions/Data.action";
...
class AirteldataScreen extends Component {
    ...
    HandleBuydataplan = async()=>{
      const {dataplan, success, errorMgs, loading} = this.props;
        ...
        await this.props.BuyData(this.state.userPhone,'airtel',this.state.dataplanId,id)
...
export default connect( MapStateToProps, {GetAirtelndata, ClearErrorMgs, BuyData})(AirteldataScreen);
