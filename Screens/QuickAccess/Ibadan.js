...
import { ValidateIbadan, clearLoginErrorMessage, PayIbadan} from "../../Redux/Actions/Electricity.action";
...
/////////////////////////////////////////////
        ...
        await this.props.ValidateIbadan(this.state.dataplanId, this.state.userPhone)
    };

    MakePayment= async()=>{   
      const {name, fsuccess,ploading,paymentsuccess, product_code, paymentdata, errormessage} = this.props;
            const id = await AsyncStorage.getItem('id');
      await this.props.PayIbadan(this.state.dataplanId, this.state.userPhone,this.state.Amount,id , product_code)}
    render(){
...
export default connect( MapStateToProps, {ValidateIbadan, clearLoginErrorMessage,PayIbadan })(IbadanScreen);
