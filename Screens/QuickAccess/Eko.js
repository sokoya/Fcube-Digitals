...
import { ValidateEko, clearLoginErrorMessage, PayEko} from "../../Redux/Actions/Electricity.action";
...
/////////////////////////////////////////////
        ...
        await this.props.ValidateEko(this.state.dataplanId, this.state.userPhone)
    };

    MakePayment= async()=>{  
      const id = await AsyncStorage.getItem('id');
         await this.props.PayEko(this.state.dataplanId,this.state.userPhone,this.state.Amount,id)
  ...
  <Text style={{color:'red', textAlign:"center"}}>{errormessage}{this.state.dataplanId}</Text>
...
export default connect( MapStateToProps, {ValidateEko, clearLoginErrorMessage, PayEko })(EkoScreen);
